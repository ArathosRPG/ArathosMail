...
public class PaperMailEconomy{
	...
	public static ItemStack getBankNote(int amount, Player player){
		...
		bankNoteLore.add(ChatColor.GRAY + "Benutze diese Schein," + ChatColor.RESET);
		bankNoteLore.add(ChatColor.GRAY + "um das Geld auf die" + ChatColor.RESET);
		bankNoteLore.add(ChatColor.GRAY + "Bank zu übertragen." + ChatColor.RESET);
	...
	public static void cashBankNote(Player player, double amount){
      ...
      }else
      {
    	  ...
    	  {
    		  player.sendMessage(ChatColor.RED + "Du hast nicht genügend Platz in deinem Inventar." + ChatColor.RESET);
    	  }
      }
